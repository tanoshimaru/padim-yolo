...
def distribute_image(image_path: str, model, grid_dirs: Dict[int, str], no_person_dir: str, 
...
def save_distribution_results(output_dir: str, distribution_count: Dict[int, int], no_person_count: int) -> str:
    """振り分け結果をファイルに保存
...
def print_distribution_results(distribution_count: Dict[int, int], no_person_count: int, result_text_path: str) -> None:
    """振り分け結果をコンソールに表示
...
def main():
    ...
    # 結果の保存と表示
    result_text_path = save_distribution_results(output_dir, distribution_count, no_person_count)
